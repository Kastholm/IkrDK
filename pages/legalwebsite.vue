<template>
  ...
  <figure class="h-[200px] min-h-[100px] respons w-[200px] bg-[#919995] clip4 absolute left-0 top-0 sm:translate-y-40"></figure>
     ...
     <ul class="mt-40 ml-36 flex-col w-[70%] sticky top-40"> 
        ...
        <a href=""><li class="text-[18px] hover:underline">1. Changes to Terms and changes to Websites</li></a>
        <a href=""><li class="text-[18px] hover:underline">2. Registration and contact forms</li></a>
        <a href=""><li class="text-[18px] hover:underline">3. Use of the Websites</li></a>
        <a href=""><li class="text-[18px] hover:underline">4. Intellectual property rights</li></a>
        <a href=""><li class="text-[18px] hover:underline">5. Limited warranty and limitation of liability</li></a>
        <a href=""><li class="text-[18px] hover:underline">6. Indemnification</li></a>
        <a href=""><li class="text-[18px] hover:underline">7. Termination</li></a>
        <a href=""><li class="text-[18px] hover:underline">8. Governing Law</li></a>
...
<h2 class="text-[29px] mt-10 text-[#256c2b] mb-3">1. Changes to Terms and changes to Websites</h2>
<p>
...
<h2 class="text-[29px] mt-10 text-[#256c2b] mb-3">2. Registration and contact forms</h2>
<p>
...
<h2 class="text-[29px] mt-10 text-[#256c2b] mb-3">3. Use of the Websites</h2>
<p>
...
<h2 class="text-[29px] mt-10 text-[#256c2b] mb-3">4. Intellectual property rights</h2>
<p>
...
<h2 class="text-[29px] mt-10 text-[#256c2b] mb-3">5. Limited warranty and limitation of liability</h2>
<p>
...
<h2 class="text-[29px] mt-10 text-[#256c2b] mb-3">6. Indemnification</h2>
<p>
...
<h2 class="text-[29px] mt-10 text-[#256c2b] mb-3">7. Termination</h2>
<p>
...
<h2  class="text-[29px] mt-10 text-[#256c2b] mb-3">8. Governing Law</h2>
<p>
...
<h2 id="contact" class="text-[29px] mt-10 text-[#256c2b] mb-3">Contact us</h2>
<p>
