<template>
  ...
  <figure class="h-[200px] min-h-[100px] respons w-[200px] bg-[#919995] clip4 absolute left-0 top-0 sm:translate-y-40"></figure>
     ...
     <ul class="mt-40 ml-36 flex-col w-[70%] sticky top-40"> 
        ...
        <a href="#legal4"><li class="text-[18px] hover:underline">4. Intellectual property rights</li></a>
        <a href="#legal5"><li class="text-[18px] hover:underline">5. Limited warranty and limitation of liability</li></a>
        <a href="#legal6"><li class="text-[18px] hover:underline">6. Indemnification</li></a>
...
<p>
    You agree to defend, indemnify and hold harmless IKR and our employees from and against all claims and expenses, including attorney’s fees, arising out of the use of the Websites by you. IKR reserves the right to take over the exclusive defense of any claim for which we are entitled to indemnification under this section. In such event, you shall provide IKR with such cooperation.
</p>
