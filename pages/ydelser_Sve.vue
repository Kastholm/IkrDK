        ...
        >
          ...
          />
              ...
              <div
                class="flex w-full justify-end mr-10 underline underline-offset-4"
              >
                <a href="/udbudUnderside_Sve" class="text-end italic -translate-y-3 cursor-pointer"
                  >Läs mer..</a
                >
              </div>
            </div>
          </a>
          <a href="/aftaleUnderside_Sve">
            <div
          ...
          />
              ...
              <div
                class="flex w-full justify-end mr-10 underline underline-offset-4"
              >
                <a href="/aftaleUnderside_Sve" class="text-end italic -translate-y-3 cursor-pointer"
                  >Läs mer..</a
                >
              </div>
            </div>
...
<script setup>
const query = groq`*[(_type == "ydelser") && lang == "Svensk" ][0]`;
