<template>
  ...
  <main class="flex flex-col justify-center">
    ...
    <div class="">
      ...
      >
        ...
        />
            ...
            >
              <a href="/oekonomiskeAnalyser" class="text-end italic -translate-y-3 cursor-pointer"
                >Læs mere..</a
              >
            </div>
          </div>
        </a>
        <a href="/udbudUnderside">
          <div
        ...
        />
            ...
            <div
              class="flex w-full justify-end mr-10 underline underline-offset-4"
            >
              <a href="/udbudUnderside" class="text-end italic -translate-y-3 cursor-pointer"
                >Læs mere..</a
              >
            </div>
          </div>
        </a>
        <a href="/aftaleUnderside">
          <div
        ...
        />
            ...
            <div
              class="flex w-full justify-end mr-10 underline underline-offset-4"
            >
              <a href="/aftaleUnderside" class="text-end italic -translate-y-3 cursor-pointer"
                >Læs mere..</a
              >
            </div>
          </div>
      ...
      >
        <figure
          class="h-[300px] min-h-[300px] respons w-[250px] bg-[#919995] clip4 absolute hidden md:block sm:show left-0 top-0"
        ></figure>
    ...
    >
      ...
      ></figure>
      <img
        src="https://i.ibb.co/QHhwXT7/Maud-ved-tastatur.jpg"
        alt=""
        class="max-h-[520px] rounded-md z-50 shadow-2xl"
      />
      <article
    ...
    <div
      class="flex flex-wrap w-full article-gap relative mt-36 gap-10 2xl:gap-24 justify-center"
    >
      <article
      ...
      <img
        src="https://i.ibb.co/y0T5FtG/Ydelser-NYT-foto-1.jpg"
        alt=""
        class="max-h-[400px] rounded-md z-50 shadow-2xl"
      />
    </div>
...
<script setup>
const query = groq`*[(_type == "ydelser") && lang == "Dansk" ][0]`;
