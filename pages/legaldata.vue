...
have concluded this Data Processing Agreement (the “Agreement”) on the Data Processor’s processing of personal data on behalf of the Data Controller.
 ...
 <p>
    The personal data to be processed by the Data Processor concerns information we are retrieving from Data controllersÂ’ website, employees. The data stored by the data processor is correspondence emails from employees, order proposals, confirmations and other relevant mails.
<br> <br>
The data processor stores the userÂ’s full name, email address, working address, phone numbers, job title and working place.
 </p>
...
Â• The Data Processor warrants to the Data Controller that it complies and will comply with its obligations as a data processor under the applicable data protection legislation.
...
o introduce login and password procedures and set up and maintain a firewall.<br><br>
o ensure the ongoing confidentiality, integrity, availability and resilience of systems and services processing personal data.
o ensure that it has the ability to restore the availability and access to the personal data in a timely manner in the event of a physical or technical incident.
o implement a process for regularly testing, assessing and evaluating the effectiveness of technical and organisational measures for ensuring the security of the processing.
o ensure the pseudonymisation and encryption of personal data when appropriate. <br><br>
o ensure that only employees with a work related purpose have access to the personal data, and ensure that all employees with access to the data shall not process the data except on instructions from the Data Controller, unless he or she is required to do so by Union or Member State Law.
o store data storage media securely so that it is not accessible to third parties.<br><br>
o ensure that buildings and systems used for data processing are secure and that only high-quality hardware and software, which is regularly updated is used.
o ensure that tests and waste material are destroyed in accordance with data protection requirements on the specific written instruction of the Data Controller. In particular cases, to be determined by the Data Controller, such tests and waste material must be stored or returned.
...
Â• If the Data Processor processes personal data in another EU/EEA member state other than Denmark, the Data Processor must also comply with any and all legislation concerning security measures in that member state.<br><br>
...
Â• The Data Processor shall promptly notify the Data Controller about any legally binding request for disclosure of the personal data by law enforcement or other applicable authority unless otherwise prohibited by applicable law.<br><br>
Â• Upon request of the Data Controller, the Data Processor shall assist the Data Controller in taking any actions deemed necessary or appropriate to deal with complaints or allegations of or in connection with a failure to comply with the applicable data protection legislation.
