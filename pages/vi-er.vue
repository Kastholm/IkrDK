<template>
 <main class="flex flex-col justify-center">
  ...
  <div class="flex w-full relative mt-36 gap-10 2xl:gap-40 justify-center">
    ...
    <img src="https://i.ibb.co/sHvRBvp/Vi-er-team.jpg" alt="" class= "max-h-[400px] rounded-md z-50">
    <article class="w-[40%] flex flex-col gap-5 -translate-y-5">
<h2 class="">Vi gør fordelene synlige fra dag 1</h2>
<p>I mere end tyve år har IKR hjulpet offentlige og private kunder som 100% uvildig rådgiver og katalysator for en positiv udvikling. Som dedikerede partnere, investerer vi i vores kunders udfordringer og er med på sidelinjen på hele rejsen.
...
<ul class="flex-col flex gap-8">
  ...
  <li><span class="text-[#256c2b] font-bold">Kontraktstyring </span> – jeres aftaler spores, overvåges og evalueres løbende af vores styringsteam. Med fingeren på pulsen sikrer I at alt hele kontraktperioden går som aftalt.  </li>
    ...
    <img src="https://i.ibb.co/qk7hLwL/vi-er-maud.jpg" alt="" class= "max-h-[400px] rounded-md z-50">
  </div>
  <Vi-erBund />
