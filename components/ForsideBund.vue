<template>
  ...
  <main v-else class="overflow-x-hidden">
    <section
      class="w-full flex justify-center items-center mt-28 2xl:mt-40 relative"
    >
      <div
    ...
    <section
      class="flex justify-center w-full relative sm:mt-20 lg:mt-10 sm:translate-x-14 iphoneforside"
    >
      <figure
