    ...
    >
      ...
      >
        ...
        >
          ...
          <p
            class="w-[90%] m-auto sm:m-0 ikrfont tekstMinW max-w-[750px] font-semibold bund-text-respons rounded-2xl py-3 sm:px-5"
          >
          <PortableText
          :value="data.text10[0]"
        ...
        <img
          ...
          class="bund-billede-respons sm:max-w-[480px] max-h-[400px] sm:mr-16 rounded-md mt- sm:mt-0 shadow-2xl"
          alt=""
        />
      </div>
    </section>
