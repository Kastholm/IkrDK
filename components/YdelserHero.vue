...
<main>
 ...
 <div class="flex justify-end">
    <div class="sm:bg-[#0a3700] bg-[#0a3700] sm:h-[350px] h-[500px] sm:w-[90%] absolute bottom-40 z-20 rounded-sm ">
        ...
        <article class="flex text-start sm:text-end flex-col sm:items-end w-[65%] 2xl:w-[78%] ml-5 sm:ml-0 sm:mt-8 mt-[70px] gap-3 italic text-[#000000] sm:max-w-full max-w-[100px]">
