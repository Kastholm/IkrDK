...
<main>
 ...
 <div class="flex justify-end">
    <div class="sm:bg-[#0a3700] bg-[#0a3700] sm:h-[350px] h-[500px] sm:w-[90%] absolute bottom-40 z-20 rounded-sm ">
        ...
        <h1 class=" font-semibold tracking-wider leading-[65px] max-w-[900px]">IKR optimerer jeres arbejdsprocesss</h1>
        ...
        <article class="flex text-start sm:text-end flex-col sm:items-end w-[78%] 2xl:w-[82%] ml-5 sm:ml-0 sm:mt-12 mt-[70px] sm:translate-y-4 gap-3 italic text-[#000000] sm:max-w-full max-w-[100px]">
            <p class="text-[20px] 2xl:text-[23px]">Troels Oberlin, Konsulent -  <a href="tel: +45 40 79 68 72" class="person-text-respons not-italic hover:underline hover:underline-offset-4"> Tlf. 40 79 68 72 </a> </p>
            <p class=" text-[20px] 2xl:text-[23px] ">Bertram Ordrup Christensens (den høje af dem) Projektleder -  <a class="person-text-respons not-italic hover:underline hover:underline-offset-4" href="tel: +45 71 99 07 61 ">Tlf. 71 99 07 61 </a></p>
        </article>
    </div>
   </div>
 </div>
