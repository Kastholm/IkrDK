<template>
  ...
  <main v-else class="overflow-x-hidden">
    ...
    >
      <div
        class="bgimg flex flex-col sm:flex-row justify-around bund-container-flex-respons 2xl:justify-center items-center max-w-full sm:max-w-full gap-[0px] 2xl:gap-[400px]"
      >
        <div
    ...
    <section
      class="flex justify-center w-full relative sm:mt-20 mt-14 lg:mt-10 sm:translate-x-14"
    >
      <figure
      ...
      >
        <div class="sm:max-w-[100%] max-w-[100%] kommentar3Eng relative">
