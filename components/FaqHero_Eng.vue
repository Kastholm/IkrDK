    ...
    >
      ...
      <div class="flex justify-end">
        ...
        >
          ...
          <article
            class="flex text-start sm:text-end flex-col sm:items-end w-[58%] personer-respons personer-respons2 2xl:w-[70%] ml-2 sm:ml-0 sm:mt-16 sm:translate-y-4 -translate-y-4 gap-3 italic text-[#000000] sm:max-w-full max-w-[100px] sm:leading-[30px] leading-[15px]"
          >
            <p
...
<script setup>
const query = groq`*[(_type == "faq") && lang == "Engelsk" ][0]`;
