<template>
  <section>
    <article class="relative sm:mt-44 flex flex-col flex-wrap w-full">
     ...
     <figure class="h-[300px] min-h-[300px] respons sm:w-[250px] w-[175px] bg-[#256c2b] clip2 absolute right-0 top-0 sm:translate-y-20 -translate-y-20"></figure>
        <div class="flex flex-col h-[400px] sm:w-[1000px] gap-5 m-auto sm:mt-0 mt-16 relative sm:mb-0 mb-16 sm:translate-y-5">
         ...
         <div class="max-w-[72vw] sm:max-w-[100%] relative">
          <h2 class=" sm:w-full sm:text-[80px] text-[30px] w-[90vw]"> Økonomiske analyser</h2>
         </div>
...
Både gennem direkte besparelser, men også via forbedringer og ændrede aftalevilkår.
...
Drift af indkøbsaftaler, konkurrenceudsættelse eller etablering af nye adfærdsmønstre kan være relevante spørgsmål, ligesom rapporten kan anvendes til organisatoriske beslutninger.
</p>
    </article>
