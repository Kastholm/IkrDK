<template>
  <main>
    <div
      class="relative max-h-[800px] sm:max-h-[900px] sm:mt-28 h-[800px] sm:h-[900px] z-10 header-img max-w-[2000px] w-full m-auto overlay"
    >
      <div
      ...
      <div class="flex justify-end">
        ...
        >
          <article
            class="flex flex-col sm:gap-10 justify-center sm:ml-28 ml-5 sm:mt-8 mt-10 text-white"
          >
            <h1
            ...
            <p class="w-[90%] sm:max-w-[700px] mt-6 sm:mt-0 mb-7 tablet-herotext-ydelser">
              <PortableText
          :value="data.text1[0]"
        ...
        />
          ...
          <article
            class="flex text-start sm:text-end flex-col sm:items-end w-[58%] personer-respons personer-respons2 2xl:w-[70%] ml-4 sm:ml-0 sm:mt-6 mt-[20px] sm:translate-y-4 sm:gap-7 gap-2 italic text-[#000000] sm:max-w-full max-w-[100px] leading-[15px] iphoneydelser"
          >
            <p
            ...
            >
              {{ worker.workertitle }},<br class="hidden sm:block"> <br> {{ worker.workerjob }}-
              <a
...
<script setup>
const query = groq`*[(_type == "ydelser") && lang == "Engelsk" ][0]`;
