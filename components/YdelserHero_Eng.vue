    ...
    >
      ...
      <div class="flex justify-end">
        ...
        />
          ...
          <article
            class="flex text-start sm:text-end flex-col sm:items-end w-[58%] personer-respons personer-respons2 2xl:w-[70%] ml-4 sm:ml-0 sm:mt-6 mt-[20px] sm:translate-y-4 sm:gap-7 gap-2 italic text-[#000000] sm:max-w-full max-w-[100px] leading-[15px]"
          >
            <p
