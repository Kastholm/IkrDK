<template>
  <section>
    <article class="relative sm:mt-44 flex flex-col flex-wrap w-full">
        <figure class="h-[300px] min-h-[300px] respons w-[250px] bg-[#919995] clip4 absolute left-0 top-0 sm:-translate-y-6 -translate-y-16 hidden sm:block"></figure>
     <figure class="h-[300px] min-h-[300px] respons w-[250px] bg-[#256c2b] clip2 absolute right-0 top-0 sm:translate-y-20 -translate-y-20"></figure>
        <div class="flex flex-col h-[400px] sm:w-[1000px] gap-5 m-auto sm:mt-0 mt-16 relative sm:mb-0 mb-16 sm:translate-y-5">
         ...
         <div class="max-w-[72vw] sm:max-w-[100%] relative">
          <h2 class="sm:w-full sm:text-[80px] text-[30px] w-[90vw]"> Aftalestyring</h2>
         </div>
     <p class="max-w-[90%] w-[90vw]">Aftaleimplementering, styring og opfølgning er en kontinuerlig proces, og helt afgørende i forhold til samarbejdet med såvel interne interessenter og leverandører – og helt basalt i forhold til den succes analyse og konkurrenceudsættelsen har synliggjort I kan opnå. 
<br><br>
