...
<main>
 <div class="relative max-h-[800px] sm:max-h-[900px] h-[800px] sm:mt-28 sm:h-[900px] z-10 header-img max-w-[2000px] w-full m-auto overlay">
   ...
   <img src="https://i.ibb.co/qyLDjTP/Pia-Jakob-Troels-NY-samarbejde-1-1.png" alt="" class="sm:h-[420px] person-respons h-64 absolute bottom-0 z-50 right-3 sm:right-0 sm:translate-x-0 "> 
 </div>
