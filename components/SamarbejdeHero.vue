...
<main>
 <div class="relative max-h-[800px] sm:max-h-[900px] h-[800px] sm:mt-28 sm:h-[900px] z-10 header-img max-w-[2000px] w-full m-auto overlay">
   ...
   <img src="https://i.ibb.co/qyLDjTP/Pia-Jakob-Troels-NY-samarbejde-1-1.png" alt="" class="sm:h-[420px] person-respons h-64 absolute bottom-0 z-50 right-3 sm:right-6 sm:translate-x-0 "> 
 </div>
 <div class="flex justify-end">
    <div class="sm:bg-[#0a3700] bg-[#0a3700] sm:h-[350px] h-[500px] sm:w-[90%] absolute bottom-40 z-20 rounded-sm ">
        ...
        <p class=" w-[90%] sm:max-w-[700px] mt-6 sm:mt-0 mb-7">”Komplekse forretningsområder er en stor del af vores specialisters arbejde hver eneste dag.” </p>
        </article>
