...
<main v-else>
 ...
 <div class="flex justify-end">
    <div class="sm:bg-[#0a3700] bg-[#0a3700] sm:h-[350px] h-[500px] sm:w-[90%] absolute bottom-40 z-20 rounded-sm ">
        ...
        <article class="flex text-start sm:text-end flex-col sm:items-end w-[58%] personer-respons personer-respons2 2xl:w-[70%] ml-2 sm:ml-0 sm:mt-12 mt-[60px] sm:translate-y-7 sm:gap-7 gap-2 leading-[15px] italic text-[#000000] sm:max-w-full max-w-[100px]">
